...
"""
    ...
    def __repr__(self):
        return f"Dog({repr(self.name)},{repr(self.age)})"
...
class JackRusselTerrier(Dog):
    ...
    def __str__(self):
        """ Give info about the instance"""
        return f"A JackRusselTerrier: {self.name} is {self.age} years old."
    
    def __repr__(self):
        return f"JackRusselTerrier({repr(self.name)},{repr(self.age)})" 
